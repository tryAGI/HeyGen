...
namespace HeyGen
{
    public partial class CreateVideoApiClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HeyGen.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HeyGen.AutoSDKHttpResponse> V2VideoGenerateAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HeyGen.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HeyGen.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "V2VideoGenerateAsync",
                                pathTemplate: "\"/v2/video/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
