...
namespace HeyGen
{
    public partial class StreamingApiClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HeyGen.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HeyGen.AutoSDKHttpResponse> StreamingStartAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HeyGen.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HeyGen.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "StreamingStartAsync",
                                pathTemplate: "\"/v1/streaming.start\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
