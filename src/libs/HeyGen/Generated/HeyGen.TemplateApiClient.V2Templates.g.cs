...
namespace HeyGen
{
    public partial class TemplateApiClient
    {
        ...
        private static readonly global::HeyGen.EndPointSecurityRequirement[] s_V2TemplatesSecurityRequirements =
            new global::HeyGen.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HeyGen.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HeyGen.AutoSDKHttpResponse> V2TemplatesAsResponseAsync(
            global::HeyGen.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
