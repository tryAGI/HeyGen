...
namespace HeyGen
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::HeyGen.AutoSDKRetryOptions Retry { get; set; } = new global::HeyGen.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::HeyGen.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::HeyGen.IAutoSDKHook>();
        ...
        public global::HeyGen.AutoSDKClientOptions AddHook(
            global::HeyGen.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::HeyGen.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::HeyGen.AutoSDKClientOptions UseAuthorizationProvider(
            global::HeyGen.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::HeyGen.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::HeyGen.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::HeyGen.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::HeyGen.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::HeyGen.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::HeyGen.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::HeyGen.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::HeyGen.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::HeyGen.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::HeyGen.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::HeyGen.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::HeyGen.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::HeyGen.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::HeyGen.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::HeyGen.AutoSDKClientOptions clientOptions,
            global::System.Func<global::HeyGen.IAutoSDKHook, global::HeyGen.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::HeyGen.AutoSDKHookContext context)
        {
